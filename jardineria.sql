...
ALTER TABLE DETALLE_PEDIDO ADD CONSTRAINT FK1_DETALLE_PEDIDO FOREIGN KEY (CODIGO_PRODUCTO) REFERENCES PRODUCTO(CODIGO_PRODUCTO);
...
ALTER TABLE PEDIDO ADD CONSTRAINT FK1_PEDIDO FOREIGN KEY (CODIGO_CLIENTE) REFERENCES CLIENTE(CODIGO_CLIENTE);
...
ALTER TABLE CLIENTE ADD CONSTRAINT FK1_CLIENTE FOREIGN KEY (CODIGO_EMPLEADO_REP_VENTAS) REFERENCES EMPLEADO(CODIGO_EMPLEADO);
...
ALTER TABLE EMPLEADO ADD FOREIGN KEY (CODIGO_OFICINA) REFERENCES OFICINA(CODIGO_OFICINA);

INSERT INTO OFICINA VALUES ('13','MADRID','ESPAÑA','MADRID','4000','653 67 98 09','AVENIDA DE LA CRUZ S/N','CALLE A LA DERECHA');

INSERT INTO EMPLEADO VALUES (1,'PEPE','HINOJO','PEREZ','CULTS','PEPHINOJO@GMAIL.COM','13',1,'325');
...
(
	...
	CODIGO_JEFE NUMBER(11),
	PUESTO VARCHAR2(50),
	CONSTRAINT PK_EMPLEADO_BACKUP PRIMARY KEY (CODIGO_EMPLEADO),
	CONSTRAINT FK1_EMPLEADO_BACKUP FOREIGN KEY (CODIGO_JEFE) REFERENCES EMPLEADO(CODIGO_EMPLEADO)
);
